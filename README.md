...
|---|---|---|
| **macOS** (Apple Silicon) | [**Voxable_0.5.3_aarch64.dmg**](https://github.com/kamicrafted/voxable/releases/download/v0.5.3/Voxable_0.5.3_aarch64.dmg) | Metal-accelerated. macOS 11+. Apple Silicon only — no Intel build. |
